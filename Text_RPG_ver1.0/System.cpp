...
void System::Menu(Player* player, Inventory* inventory)
{
	...
	{
		cout << endl;
		cout << "1. 진행하기" << endl << endl;
		cout << "2. 플레이어 정보확인" << endl << endl;
		cout << "3. 인벤토리 확인" << endl << endl;
		int input;
		cin >> input;
		if (input == 1)
		{
...
void System::BeginStory()
{
	system("cls");
	cout << endl;
	cout << "왕국령 310년" << endl << endl;
	cout << "몬스터들이 나타나 이 세계는 큰 혼란에 빠지게 된다" << endl << endl;
	event.NextStage();
	system("cls");
	cout << endl;
	cout << "그 때, 주신인 주사위 여신이 나타나 한 사람에게" << endl << endl;
	cout << "주사위를 주며 이 세계를 구해달라고 한다" << endl << endl;
	event.NextStage();
	system("cls");
	cout << endl;
	cout << "여신 : 용사님 부디 주사위로 이 세계를 구원해주세요.." << endl << endl;
	event.NextStage();
	system("cls");
	cout << endl;
	cout << "자, 모험을 시작해보자!" << endl << endl;
	event.NextStage();
	system("cls");
}
...
void System::Explanation()
{
	...
	cout << endl;
	cout << "기본적으로 주사위로 거의 모든걸 진행합니다" << endl << endl;
	cout << "하나의 스테이지는 랜덤하게 발생한 두가지 이벤트들에서" << endl << endl;
	cout << "하나를 골라서 진행하게 됩니다" << endl << endl;
	cout << "10번의 이벤트 진행 후 보스전을 하게 되고" << endl << endl;
	cout << "보스몬스터를 세 번 무찌르면 클리어하게 됩니다" << endl << endl;
	cout << "(보스전에서 승리할 시 최대체력이 + 1됨과 동시에 풀로 채워줍니다)" << endl << endl;
	cout << "전투는 서로 주사위들을 던져서 합이 더 높은 쪽이 승리합니다" << endl << endl;
